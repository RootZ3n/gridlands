...
| P2 | Full-cell terrain scaling at 256 m / 512 m / 1 km / 2 km | **DONE 2026-09-25**: rendering is not the limit; memory and load time are ([evidence](Evidence/P2-terrain-scale/README.md)) |
| P3 | Two physical Grid cells, streaming and per-cell saves ([ADR-0026](ADR/0026-grid-cells-and-streaming.md)) | **DONE 2026-09-25** ([evidence](Evidence/P3-grid-cells/README.md)) |
| P4 | Presentation: subtitles, prompts, terrain material, de-rez | **DONE 2026-09-25** ([evidence](Evidence/P4-presentation/README.md)) |
| P5 | Canonical 1 km scale ([ADR-0027](ADR/0027-canonical-grid-scale.md)), seamless streaming ([ADR-0028](ADR/0028-seamless-grid-streaming.md)), localized navigation ([ADR-0029](ADR/0029-localized-navigation.md)) | **GREEN 2026-09-25**: 91/91; 6 planted defects caught; 1 km crossings with 0 emergency chunks, worst hitch 34 ms (engine level removal); localized navigation 0.53 s vs 7.64 s ([evidence](Evidence/P5-seamless-grid/README.md)) |
| P6 | Structural salvage, natural gathering, gravity collapse and authoritative noise ([ADR-0030](ADR/0030-structural-salvage-and-deterministic-collapse.md), [ADR-0031](ADR/0031-authoritative-world-noise.md)) | **GREEN 2026-09-25**: real-game A–T all PASS; 8 planted defects caught; collapse decision ≤ 0.16 ms; P5 budgets hold ([evidence](Evidence/P6-structural-salvage/README.md)) |
| P7 | Visual language and authoring pipeline spike ([ADR-0032](ADR/0032-visual-pipeline-and-stylization.md), [ART-PIPELINE](ART-PIPELINE.md), [STRUCTURE-AUTHORING](STRUCTURE-AUTHORING.md)) | **ENGINEERING: see [evidence](Evidence/P7-visual-spike/README.md). VISUAL: AWAITING OPERATOR.** Not GREEN until the operator approves the look |
| M11 | **First vertical slice (integrated)** | **GREEN 2026-09-25**: everything in one world, and it persists. The riddle; 5 glitches incl. the storm drain's; storm on the 2nd repair; shelter; terraform; Grid Clear. The gremlin can be fought, avoided, or distracted by Pehlichi (zero damage). The storm is bounded and cleans up. Discoveries; ambient and silence; 49 exchanges. `-GLSettings`. 78 tests ([evidence](Evidence/M11/README.md), [ADR-0025](ADR/0025-slice-creature-combat-storm-v0.md)) |
