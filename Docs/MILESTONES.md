...
| P6 | Structural salvage, natural gathering, gravity collapse and authoritative noise (operator brief 2026-09-25) | **Not started: awaiting an operator decision on the structural representation and collapse authority** (see the P6 decision note in the PR / report). The docs update, P5 decisions and P5 regression budget are done |
